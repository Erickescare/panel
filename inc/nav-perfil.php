	...
	<div class="kt-widget kt-widget--user-profile-1">
		...
		<div class="kt-widget__body">
			...
			<div class="kt-widget__items">
				<a href="./perfil.php" class="kt-widget__item <?= ($activePage == 'perfil') ? 'kt-widget__item--active':''; ?>">
				...
				<a href="./cambiar-correo.php" class="kt-widget__item <?= ($activePage == 'cambiar-correo') ? 'kt-widget__item--active':''; ?>">
					<span class="kt-widget__section">
						<span class="kt-widget__icon">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
								<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				...
				<a href="#" class="kt-widget__item" data-toggle="kt-tooltip" title="Próximamente..." data-placement="right">
					<span class="kt-widget__section">
						...
						<span href="#" class="kt-widget__desc">Información sobre los impuestos</span>
					</span>
				</a>
				<a href="#" class="kt-widget__item" data-toggle="kt-tooltip" title="Próximamente..." data-placement="right">
					<span class="kt-widget__section">
