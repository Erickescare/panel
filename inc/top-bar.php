...
<div class="kt-header__topbar">
			...
			<form>
				...
				<div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(./assets/media/misc/bg-1.jpg)">
					...
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#topbar_notifications_logs" role="tab" aria-selected="false">Registros</a>
						</li>
					</ul>
				</div>
				<!--end: Head -->
					...
					<div class="tab-pane active show" id="topbar_notifications_notifications" role="tabpanel">
						<div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true" data-height="300" data-mobile-height="200">
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										El nuevo cliente está registrado
									</div>
									<div class="kt-notification__item-time">
										Hace 3 hrs
									</div>
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										Comentarios de nuevos usuarios recibidos
									</div>
									<div class="kt-notification__item-time">
										Hace 8 hrs
									</div>
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										El reinicio del sistema se ha completado con éxito
									</div>
									<div class="kt-notification__item-time">
										Hace 12 hrs
									</div>
							...
							<a href="#" class="kt-notification__item kt-notification__item--read">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										Reunión de la empresa cancelada
									</div>
									<div class="kt-notification__item-time">
										Hace 19 hrs
									</div>
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										Se ha generado informe financiero.
									</div>
									<div class="kt-notification__item-time">
										Hace 25 hrs
									</div>
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										Nuevo comentario de cliente recibido
									</div>
									<div class="kt-notification__item-time">
										hace 2 días
									</div>
						...
						<div class="kt-grid kt-grid--ver" style="min-height: 200px;">
							<div class="kt-grid kt-grid--hor kt-grid__item kt-grid__item--fluid kt-grid__item--middle">
								<div class="kt-grid__item kt-grid__item--middle kt-align-center">
									¡Todo vistos!
									<br> No hay nuevas notificaciones.
								</div>
							</div>
						</div>
					</div>
				...
				<div class="kt-grid-nav kt-grid-nav--skin-light">
					<div class="kt-grid-nav__row">
						<a href="#" class="kt-grid-nav__item">
							...
							<span class="kt-grid-nav__title">Contabilidad</span>
						...
						<a href="#" class="kt-grid-nav__item">
							...
							<span class="kt-grid-nav__title">Administración</span>
							<span class="kt-grid-nav__desc">Consola</span>
						</a>
					</div>
					<div class="kt-grid-nav__row">
						<a href="#" class="kt-grid-nav__item">
							...
							<span class="kt-grid-nav__title">Proyectos</span>
							<span class="kt-grid-nav__desc">Tareas pendientes</span>
						</a>
						<a href="#" class="kt-grid-nav__item">
							<span class="kt-grid-nav__icon">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
							...
							<span class="kt-grid-nav__desc">Últimos casos</span>
						</a>
					</div>
				</div>
				<!--end: Grid Nav -->
	...
	<!--end: Quick actions -->
	<!--begin: Quick panel -->
	<div class="kt-header__topbar-item kt-header__topbar-item--quick-panel" data-toggle="kt-tooltip" title="Panel rapido" data-placement="left">
	...
	<div class="kt-header__topbar-item kt-header__topbar-item--langs">
		<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,10px">
			<span class="kt-header__topbar-icon">
				<img class="" src="./assets/media/flags/22-mexico.svg" alt="" />
			</span>
		</div>
			...
			<ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
				<li class="kt-nav__item kt-nav__item--active">
					<a href="#" class="kt-nav__link">
						<span class="kt-nav__link-icon"><img src="./assets/media/flags/22-mexico.svg" alt="" /></span>
	...
	<div class="kt-header__topbar-item kt-header__topbar-item--user">
		...
		<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
			...
			<div class="kt-notification">
				<a href="perfil.php" class="kt-notification__item">
					<div class="kt-notification__item-icon">
				...
				<a href="./mi_salida.php" class="kt-notification__item">
					...
					<div class="kt-notification__item-details">
						...
						<div class="kt-notification__item-time" data-toggle="kt-tooltip" title="Habilitada a partir 4:15 PM" data-placement="right">
							Ver mi proxima hora de Salida
						</div>
					</div>
				</a>
				<a href="./tabla.php" class="kt-notification__item">
					...
					<div class="kt-notification__item-details">
						...
						<div class="kt-notification__item-time">
							facturación y extractos <abarcan clase = "kt-badge kt-badge - peligro kt-badge - en línea kt-badge - píldora kt-badge - redondeado"> 2 pendiente</span>
						</div>
					</div>
				</a>
