														...
														<div class="kt-widget__head">
															...
															<div class="kt-widget__content">
																...
																<div class="kt-widget__action">
																	...
																	<!-- <button type="button" class="btn btn-success btn-sm">Reportar</button> -->
																</div>
															</div>
														</div>
														<div class="kt-widget__body">
															<div class="kt-widget__content">
																<div class="kt-widget__info">
																	...
																	<a href="#" class="kt-widget__data">erick.escareno@gmail.com</a>
																</div>
																<div class="kt-widget__info">
																	<span class="kt-widget__label">Teléfono:</span>
																	<a href="#" class="kt-widget__data">8399 2626 Ext. 2603</a>
																</div>
																<div class="kt-widget__info">
																	<span class="kt-widget__label">Ubicación:</span>
																	<span class="kt-widget__data">Monterrey</span>
																</div>
															</div>
															<div class="kt-widget__items">
																...
																<a href="#" class="kt-widget__item" data-toggle="kt-tooltip" title="Proximamente..." data-placement="right">
																	<span class="kt-widget__section">
																		<span class="kt-widget__icon">
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																...
																<a href="#" class="kt-widget__item" data-toggle="kt-tooltip" title="Proximamente..." data-placement="right">
																	<span class="kt-widget__section">
																		...
																		<span href="#" class="kt-widget__desc">Impuestos</span>
																	</span>
